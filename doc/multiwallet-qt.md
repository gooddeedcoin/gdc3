...
Only requiring some minor changes is gdc.cpp.
...
Changes to gdc.cpp
----------------------
gdc.cpp is the entry point into bitcoin-qt, and as such, will require some minor modifications to provide hooks for
