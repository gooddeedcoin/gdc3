...
RESOURCES += src/qt/gdc.qrc src/qt/gdc_locale.qrc
TRANSLATIONS += src/qt/locale/gdc_bg.ts \
                src/qt/locale/gdc_de.ts \
                src/qt/locale/gdc_en.ts \
                src/qt/locale/gdc_es.ts \
                src/qt/locale/gdc_fi.ts \
                src/qt/locale/gdc_fr.ts \
                src/qt/locale/gdc_it.ts \
                src/qt/locale/gdc_ja.ts \
                src/qt/locale/gdc_pl.ts \
                src/qt/locale/gdc_pt.ts \
                src/qt/locale/gdc_ru.ts \
                src/qt/locale/gdc_sk.ts \
                src/qt/locale/gdc_sv.ts \
                src/qt/locale/gdc_vi.ts \
                src/qt/locale/gdc_zh_CN.ts \
                src/qt/locale/gdc_zh_TW.ts
